                ...
                <article className='contactFormContainer'>
                    ...
                    <form className='contactForm'>
                        <label className='contactFormLabel' htmlFor='name'>
                            ...
                            <input className='formInput' typeof='text' name='name' id='name' required onFocus={()=>{setNameState(true)}} onBlur={()=>{setNameState(false)}}/>
                        </label>
                        <label className='contactFormLabel' htmlFor='mail'>
                            ...
                            <input className='formInput' typeof='email' name='email' id='email' required onFocus={()=>{setMailState(true)}} onBlur={()=>{setMailState(false)}}/>
                        </label>
                        <label className='contactFormLabel' htmlFor='phone'>
                            ...
                            <input className='formInput' typeof='number' name='phone' id='phone' required onFocus={()=>{setPhoneState(true)}} onBlur={()=>{setPhoneState(false)}}/>
                        </label>
                        <label className='contactFormLabel' htmlFor='message'>
                            ...
                            <textarea className='formInput formInputTextArea' typeof='text' name='message' id='message' required onFocus={()=>{setMessageState(true)}} onBlur={()=>{setMessageState(false)}}/>
                        </label>
                    </form>
                </article>
